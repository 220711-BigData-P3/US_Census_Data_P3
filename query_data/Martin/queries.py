...
all_years = spark.sql("SELECT 2000_1.STUSAB AS STATE, 2000_1.P0010001 AS POP_2000, 2010_1.P0010001 AS POP_2010, 2020_P1.P0010001 AS POP_2020 FROM 2000_1 JOIN 2010_1 ON 2000_1.STUSAB = 2010_1.STUSAB JOIN 2020_P1 ON 2000_1.STUSAB = 2020_P1.STUSAB")
