...
GROWTH2020TO2010 = spark.sql("SELECT census2020_1.STUSAB as STATE , census2020_1.P0010001 as 2020_Population ,\
...
GROWTH2010TO2000 = spark.sql("SELECT census2010_1.STUSAB as STATE , census2010_1.P0010001 as 2010_Population ,\
...
GROWTH2020TO2000 = spark.sql("SELECT census2020_1.STUSAB as STATE , census2020_1.P0010001 as 2020_Population ,\
...
Pop_Incr_2010_to_2000.show()
Pop_Decr_2010_to_2000.show()
...
Pop_Incr_2010_to_2000.write.csv(path + "/Pop_Incr_2010_to_2000")
Pop_Decr_2010_to_2000.write.csv(path + "/Pop_Decr_2010_to_2000")
