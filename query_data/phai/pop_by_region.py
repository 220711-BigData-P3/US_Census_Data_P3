...
northeast_pop = spark.sql(
    "SELECT SUM(P0010001) AS total_population FROM northeast_view"
)
southeast_pop = spark.sql(
    "SELECT SUM(P0010001) AS total_population FROM southeast_view"
)
southwest_pop = spark.sql(
    "SELECT SUM(P0010001) AS total_population FROM southwest_view"
)
...
all_regions_2000_query = spark.sql(
    "SELECT region, total_population FROM all_regions_view"
)
print("Regional data for 2000: ")
all_regions_2000_query.show()
highest_pop_2000 = spark.sql(
    "SELECT region, total_population FROM all_regions_view WHERE total_population = (SELECT MAX(total_population) FROM all_regions_view)"
)
...
all_regions_2010_query = spark.sql(
    "SELECT region, total_population FROM all_regions_view"
)
print("Regional data for 2010: ")
all_regions_2010_query.show()
highest_pop_2010 = spark.sql(
    "SELECT region, total_population FROM all_regions_view WHERE total_population = (SELECT MAX(total_population) FROM all_regions_view)"
)
...
all_regions_2020_query = spark.sql(
    "SELECT region, total_population FROM all_regions_view"
)
print("Regional data for 2020: ")
all_regions_2020_query.show()
highest_pop_2020 = spark.sql(
    "SELECT region, total_population FROM all_regions_view WHERE total_population = (SELECT MAX(total_population) FROM all_regions_view)"
)
