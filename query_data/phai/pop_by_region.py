...
midwest_df = rdd_2010.filter((rdd_2010.STUSAB == "IA") | (rdd_2010.STUSAB == "KS") | (rdd_2010.STUSAB == "MO")| (rdd_2010.STUSAB == "NE")| (rdd_2010.STUSAB == "ND") | (rdd_2010.STUSAB == "SD") | (rdd_2010.STUSAB == "IL") | (rdd_2010.STUSAB == "IN") | (rdd_2010.STUSAB == "MI") | (rdd_2010.STUSAB == "MN") | (rdd_2010.STUSAB == "OH") | (rdd_2010.STUSAB == "WI"))
midwest_view = midwest_df.createOrReplaceTempView("midwest_view")
northeast_df = rdd_2010.filter((rdd_2010.STUSAB == "CT") | (rdd_2010.STUSAB == "DE") | (rdd_2010.STUSAB == "MA") | (rdd_2010.STUSAB == "ME") | (rdd_2010.STUSAB == "NH") | (rdd_2010.STUSAB == "NJ") | (rdd_2010.STUSAB == "NY") | (rdd_2010.STUSAB == "PA") | (rdd_2010.STUSAB == "RI") | (rdd_2010.STUSAB == "VT"))
northeast_view = northeast_df.createOrReplaceTempView("northeast_view")
southeast_df = rdd_2010.filter((rdd_2010.STUSAB == "AL") | (rdd_2010.STUSAB == "AR") | (rdd_2010.STUSAB == "FL") | (rdd_2010.STUSAB == "GA") | (rdd_2010.STUSAB == "KY") | (rdd_2010.STUSAB == "LA") | (rdd_2010.STUSAB == "MD") | (rdd_2010.STUSAB == "MS") | (rdd_2010.STUSAB == "NC") | (rdd_2010.STUSAB == "SC") | (rdd_2010.STUSAB == "TN") | (rdd_2010.STUSAB == "VA") | (rdd_2010.STUSAB == "WV"))
southeast_view = southeast_df.createOrReplaceTempView("southeast_view")
southwest_df = rdd_2010.filter((rdd_2010.STUSAB == "AZ") | (rdd_2010.STUSAB == "CA") | (rdd_2010.STUSAB == "CO") | (rdd_2010.STUSAB == "NV") | (rdd_2010.STUSAB == "NM") | (rdd_2010.STUSAB == "OK") | (rdd_2010.STUSAB == "TX") | (rdd_2010.STUSAB == "UT"))
southwest_view = southwest_df.createOrReplaceTempView("southwest_view")
west_df = rdd_2010.filter((rdd_2010.STUSAB == "AK") | (rdd_2010.STUSAB == "ID") | (rdd_2010.STUSAB == "MT") | (rdd_2010.STUSAB == "WY") | (rdd_2010.STUSAB == "WA") | (rdd_2010.STUSAB == "OR") | (rdd_2010.STUSAB == "HI"))
west_view = west_df.createOrReplaceTempView("west_view")
...
midwest_df = rdd_2020.filter((rdd_2020.STUSAB == "IA") | (rdd_2020.STUSAB == "KS") | (rdd_2020.STUSAB == "MO")| (rdd_2020.STUSAB == "NE")| (rdd_2020.STUSAB == "ND") | (rdd_2020.STUSAB == "SD") | (rdd_2020.STUSAB == "IL") | (rdd_2020.STUSAB == "IN") | (rdd_2020.STUSAB == "MI") | (rdd_2020.STUSAB == "MN") | (rdd_2020.STUSAB == "OH") | (rdd_2020.STUSAB == "WI"))
midwest_view = midwest_df.createOrReplaceTempView("midwest_view")
northeast_df = rdd_2020.filter((rdd_2020.STUSAB == "CT") | (rdd_2020.STUSAB == "DE") | (rdd_2020.STUSAB == "MA") | (rdd_2020.STUSAB == "ME") | (rdd_2020.STUSAB == "NH") | (rdd_2020.STUSAB == "NJ") | (rdd_2020.STUSAB == "NY") | (rdd_2020.STUSAB == "PA") | (rdd_2020.STUSAB == "RI") | (rdd_2020.STUSAB == "VT"))
northeast_view = northeast_df.createOrReplaceTempView("northeast_view")
southeast_df = rdd_2020.filter((rdd_2020.STUSAB == "AL") | (rdd_2020.STUSAB == "AR") | (rdd_2020.STUSAB == "FL") | (rdd_2020.STUSAB == "GA") | (rdd_2020.STUSAB == "KY") | (rdd_2020.STUSAB == "LA") | (rdd_2020.STUSAB == "MD") | (rdd_2020.STUSAB == "MS") | (rdd_2020.STUSAB == "NC") | (rdd_2020.STUSAB == "SC") | (rdd_2020.STUSAB == "TN") | (rdd_2020.STUSAB == "VA") | (rdd_2020.STUSAB == "WV"))
southeast_view = southeast_df.createOrReplaceTempView("southeast_view")
southwest_df = rdd_2020.filter((rdd_2020.STUSAB == "AZ") | (rdd_2020.STUSAB == "CA") | (rdd_2020.STUSAB == "CO") | (rdd_2020.STUSAB == "NV") | (rdd_2020.STUSAB == "NM") | (rdd_2020.STUSAB == "OK") | (rdd_2020.STUSAB == "TX") | (rdd_2020.STUSAB == "UT"))
southwest_view = southwest_df.createOrReplaceTempView("southwest_view")
west_df = rdd_2020.filter((rdd_2020.STUSAB == "AK") | (rdd_2020.STUSAB == "ID") | (rdd_2020.STUSAB == "MT") | (rdd_2020.STUSAB == "WY") | (rdd_2020.STUSAB == "WA") | (rdd_2020.STUSAB == "OR") | (rdd_2020.STUSAB == "HI"))
west_view = west_df.createOrReplaceTempView("west_view")
